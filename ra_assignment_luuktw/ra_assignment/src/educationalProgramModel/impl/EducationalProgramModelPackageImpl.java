...
import educationalProgramModel.EducationalProgramModelFactory;
import educationalProgramModel.EducationalProgramModelPackage;
import educationalProgramModel.Person;
import educationalProgramModel.Program;
...
import educationalProgramModel.assessmentTypes;

import educationalProgramModel.util.EducationalProgramModelValidator;
 ...
 * @generated
 */
public class EducationalProgramModelPackageImpl extends EPackageImpl implements EducationalProgramModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see educationalProgramModel.EducationalProgramModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private EducationalProgramModelPackageImpl() {
		super(eNS_URI, EducationalProgramModelFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link EducationalProgramModelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static EducationalProgramModelPackage init() {
		if (isInited) return (EducationalProgramModelPackage)EPackage.Registry.INSTANCE.getEPackage(EducationalProgramModelPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredEducationalProgramModelPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		EducationalProgramModelPackageImpl theEducationalProgramModelPackage = registeredEducationalProgramModelPackage instanceof EducationalProgramModelPackageImpl ? (EducationalProgramModelPackageImpl)registeredEducationalProgramModelPackage : new EducationalProgramModelPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theEducationalProgramModelPackage.createPackageContents();

		// Initialize created meta-data
		theEducationalProgramModelPackage.initializePackageContents();

		// Register package validator
		EValidator.Registry.INSTANCE.put
			(theEducationalProgramModelPackage,
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return EducationalProgramModelValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theEducationalProgramModelPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(EducationalProgramModelPackage.eNS_URI, theEducationalProgramModelPackage);
		return theEducationalProgramModelPackage;
	}
	 ...
	 * @generated
	 */
	public EducationalProgramModelFactory getEducationalProgramModelFactory() {
		return (EducationalProgramModelFactory)getEFactoryInstance();
	}
...
} //EducationalProgramModelPackageImpl
