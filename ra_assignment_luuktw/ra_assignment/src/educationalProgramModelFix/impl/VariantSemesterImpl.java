 ...
 * </p>
 * <ul>
 *   <li>{@link educationalProgramModelFix.impl.VariantSemesterImpl#getSemesterChoices <em>Semester Choices</em>}</li>
 *   <li>{@link educationalProgramModelFix.impl.VariantSemesterImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariantSemesterImpl extends MinimalEObjectImpl.Container implements VariantSemester {
	...
	protected EClass eStaticClass() {
		return EducationalProgramModelFixPackage.Literals.VARIANT_SEMESTER;
	}
	...
	public EList<Semester> getSemesterChoices() {
		if (semesterChoices == null) {
			semesterChoices = new EObjectContainmentEList<Semester>(Semester.class, this, EducationalProgramModelFixPackage.VARIANT_SEMESTER__SEMESTER_CHOICES);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EducationalProgramModelFixPackage.VARIANT_SEMESTER__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EducationalProgramModelFixPackage.VARIANT_SEMESTER__SEMESTER_CHOICES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EducationalProgramModelFixPackage.VARIANT_SEMESTER__NAME:
				return getName();
		}
