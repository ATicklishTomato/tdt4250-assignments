 ...
 * </p>
 * <ul>
 *   <li>{@link educationalProgramModelFix.impl.YearImpl#getSemesters <em>Semesters</em>}</li>
 *   <li>{@link educationalProgramModelFix.impl.YearImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link educationalProgramModelFix.impl.YearImpl#getVariantSemesters <em>Variant Semesters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YearImpl extends MinimalEObjectImpl.Container implements Year {
	...
	protected EClass eStaticClass() {
		return EducationalProgramModelFixPackage.Literals.YEAR;
	}
	...
	public EList<Semester> getSemesters() {
		if (semesters == null) {
			semesters = new EObjectContainmentEList<Semester>(Semester.class, this, EducationalProgramModelFixPackage.YEAR__SEMESTERS);
		}
		return semesters;
	}
	...
	public void setNumber(int newNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EducationalProgramModelFixPackage.YEAR__NUMBER, oldNumber, number));
	}
	...
	public EList<VariantSemester> getVariantSemesters() {
		if (variantSemesters == null) {
			variantSemesters = new EObjectContainmentEList<VariantSemester>(VariantSemester.class, this, EducationalProgramModelFixPackage.YEAR__VARIANT_SEMESTERS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EducationalProgramModelFixPackage.YEAR__SEMESTERS:
				return ((InternalEList<?>)getSemesters()).basicRemove(otherEnd, msgs);
			case EducationalProgramModelFixPackage.YEAR__VARIANT_SEMESTERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EducationalProgramModelFixPackage.YEAR__SEMESTERS:
				return getSemesters();
			case EducationalProgramModelFixPackage.YEAR__NUMBER:
				return getNumber();
			case EducationalProgramModelFixPackage.YEAR__VARIANT_SEMESTERS:
