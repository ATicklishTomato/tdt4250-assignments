...
import educationalProgramModel.Assessment;
 ...
 * </p>
 * <ul>
 *   <li>{@link educationalProgramModel.impl.CourseImpl#getName <em>Name</em>}</li>
 *   <li>{@link educationalProgramModel.impl.CourseImpl#getCode <em>Code</em>}</li>
 *   <li>{@link educationalProgramModel.impl.CourseImpl#getStaff <em>Staff</em>}</li>
 *   <li>{@link educationalProgramModel.impl.CourseImpl#getCredits <em>Credits</em>}</li>
 *   <li>{@link educationalProgramModel.impl.CourseImpl#getStudyLevel <em>Study Level</em>}</li>
 *   <li>{@link educationalProgramModel.impl.CourseImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link educationalProgramModel.impl.CourseImpl#getResponsibleUnit <em>Responsible Unit</em>}</li>
 *   <li>{@link educationalProgramModel.impl.CourseImpl#getAssessments <em>Assessments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CourseImpl extends MinimalEObjectImpl.Container implements Course {
	...
	protected EClass eStaticClass() {
		return EducationalProgramModelPackage.Literals.COURSE;
	}
	...
	public EList<String> getName() {
		if (name == null) {
			name = new EDataTypeUniqueEList<String>(String.class, this, EducationalProgramModelPackage.COURSE__NAME);
		}
		return name;
	}
	...
	public void setCode(String newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EducationalProgramModelPackage.COURSE__CODE, oldCode, code));
	}
	...
	public EList<Person> getStaff() {
		if (staff == null) {
			staff = new EObjectWithInverseResolvingEList.ManyInverse<Person>(Person.class, this, EducationalProgramModelPackage.COURSE__STAFF, EducationalProgramModelPackage.PERSON__ASSIGNED_COURSES);
		}
		return staff;
	}
	...
	public void setCredits(double newCredits) {
		...
		credits = newCredits;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EducationalProgramModelPackage.COURSE__CREDITS, oldCredits, credits));
	}
	...
	public void setStudyLevel(String newStudyLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EducationalProgramModelPackage.COURSE__STUDY_LEVEL, oldStudyLevel, studyLevel));
	}
	...
	public EList<String> getLanguage() {
		if (language == null) {
			language = new EDataTypeUniqueEList<String>(String.class, this, EducationalProgramModelPackage.COURSE__LANGUAGE);
		}
		return language;
	}
	...
	public EList<String> getResponsibleUnit() {
		if (responsibleUnit == null) {
			responsibleUnit = new EDataTypeUniqueEList<String>(String.class, this, EducationalProgramModelPackage.COURSE__RESPONSIBLE_UNIT);
		}
	...
	public EList<Assessment> getAssessments() {
		if (assessments == null) {
			assessments = new EObjectContainmentEList<Assessment>(Assessment.class, this, EducationalProgramModelPackage.COURSE__ASSESSMENTS);
		}
		return assessments;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EducationalProgramModelPackage.COURSE__STAFF:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case EducationalProgramModelPackage.COURSE__ASSESSMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EducationalProgramModelPackage.COURSE__NAME:
				return getName();
			case EducationalProgramModelPackage.COURSE__CODE:
				return getCode();
			case EducationalProgramModelPackage.COURSE__STAFF:
				return getStaff();
			case EducationalProgramModelPackage.COURSE__CREDITS:
				return getCredits();
			case EducationalProgramModelPackage.COURSE__STUDY_LEVEL:
				return getStudyLevel();
			case EducationalProgramModelPackage.COURSE__LANGUAGE:
				return getLanguage();
			case EducationalProgramModelPackage.COURSE__RESPONSIBLE_UNIT:
